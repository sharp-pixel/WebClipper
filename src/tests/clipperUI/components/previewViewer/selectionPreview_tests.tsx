...
QUnit.test("The selection's highlightable preview body should render the content", () => {
...
QUnit.test("The selection preview's highlightable preview body should render the content as HTML, not purely text", () => {
