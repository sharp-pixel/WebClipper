...
QUnit.test("shouldSet to return true if notebooks is to be set and userInformation exists in storage", () => {
...
QUnit.test("shouldSet to return false if notebooks is to be set and userInformation does not exist in storage", () => {
	ok(!strategy.shouldSet(ClipperStorageKeys.cachedNotebooks, "{}"),
		"Setting of cached notebooks should not be allowed if userInformation does not exist");
});

QUnit.test("shouldSet to return true if undefined or empty string notebooks is to be set and userInformation does not exist in storage", () => {
...
QUnit.test("shouldSet to return true if current section is to be set and userInformation exists in storage", () => {
	mockStorage.setValue(ClipperStorageKeys.userInformation, "{}");
...
QUnit.test("shouldSet to return false if current section is to be set and userInformation does not exist in storage", () => {
	ok(!strategy.shouldSet(ClipperStorageKeys.currentSelectedSection, "{}"),
		"Setting of cached current section should not be allowed if userInformation does not exist");
});

QUnit.test("shouldSet to return true if undefined or empty string current section is to be set and userInformation does not exist in storage", () => {
	ok(strategy.shouldSet(ClipperStorageKeys.cachedNotebooks, undefined),
...
QUnit.test("shouldSet to return true for non-personal-items even if userInformation does not exist", () => {
