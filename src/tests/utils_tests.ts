...
QUnit.test("addUrlQueryValue should add a name/value pair to a url that contains existing (and different) name/value pairs", () => {
...
QUnit.test("addUrlQueryValue should add a name/value pair to a url that does not already contain a name/value pair", () => {
...
QUnit.test("addUrlQueryValue should add a name/value pair correctly if the url contains a fragment and a name/value pair", () => {
...
QUnit.test("addUrlQueryValue should add a name/value pair correctly if the url contains a fragment but not a name/value pair", () => {
...
QUnit.test("addUrlQueryValue should replace the value of an existing name in the query string", () => {
...
QUnit.test("addUrlQueryValue should return the originalUrl parameter when passed an empty url", () => {
	let url = "";
	strictEqual(Utils.addUrlQueryValue(url, "name", "value"), url, "The originalUrl should be returned");
});

QUnit.test("addUrlQueryValue should return the originalUrl parameter when passed a null url", () => {
...
QUnit.test("addUrlQueryValue should return the originalUrl parameter when passed an undefined url", () => {
	let url = undefined;
	strictEqual(Utils.addUrlQueryValue(url, "name", "value"), url, "The originalUrl should be returned");
});

QUnit.test("addUrlQueryValue should return the originalUrl parameter when passed an empty name", () => {
...
QUnit.test("addUrlQueryValue should return the originalUrl parameter when passed a null name", () => {
	/* tslint:disable:no-null-keyword */
	let url = "http://www.thiswebsite.rules/strings?";
...
QUnit.test("addUrlQueryValue should return the originalUrl parameter when passed an undefined name", () => {
	let url = "http://www.thiswebsite.rules/strings?";
	strictEqual(Utils.addUrlQueryValue(url, undefined, "value"), url, "The originalUrl should be returned");
});

QUnit.test("addUrlQueryValue should return the originalUrl parameter when passed an empty value", () => {
	let url = "http://www.thiswebsite.rules/strings?";
	strictEqual(Utils.addUrlQueryValue(url, "name", ""), url, "The originalUrl should be returned");
});

QUnit.test("addUrlQueryValue should return the originalUrl parameter when passed a null value", () => {
	/* tslint:disable:no-null-keyword */
	let url = "http://www.thiswebsite.rules/strings?";
...
QUnit.test("addUrlQueryValue should return the originalUrl parameter when passed an undefined value", () => {
	let url = "http://www.thiswebsite.rules/strings?";
	strictEqual(Utils.addUrlQueryValue(url, "name", undefined), url, "The originalUrl should be returned");
});

QUnit.test("addUrlQueryValue should camel case the query param key added when told to do so", () => {
...
QUnit.test("generateSignInUrl should generate the correct URL given a valid clipperId, sessionId and MSA authType", () => {
...
QUnit.test("generateSignInUrl should generate the correct URL given a valid clipperId, sessionId, and O365 authType", () => {
...
QUnit.test("generateSignOutUrl should generate the correct URL given a valid clipperId, sessionId and MSA authType", () => {
...
QUnit.test("generateSignOutUrl should generate the correct URL given a valid clipperId, sessionId, and O365 authType", () => {
...
QUnit.test("getFileNameFromUrl should return the file name when the url has a pdf file name", () => {
...
QUnit.test("getFileNameFromUrl should return the file name when the url has a doc file name", () => {
...
QUnit.test("getFileNameFromUrl should return the file name when the url has a doc file name and a number in the file name", () => {
...
QUnit.test("getFileNameFromUrl should return the file name when the url has a doc file name and a number in the extension", () => {
...
QUnit.test("getFileNameFromUrl should return the file name when the url has a doc file name while preserving casing", () => {
...
QUnit.test("getFileNameFromUrl should return the file name when the url has a doc file name and the url is valid but unusual/unexpected", () => {
...
QUnit.test("getFileNameFromUrl should return undefined when the url has no file name by default", () => {
...
QUnit.test("getFileNameFromUrl should return the fallback when the url has no file name when the fallback is specified", () => {
...
QUnit.test("getFileNameFromUrl should return the fallback when passed an empty url", () => {
	let fallback = "Fallback.xyz";
	strictEqual(Utils.getFileNameFromUrl("", fallback), fallback,
		"The fallback should be returned");
});

QUnit.test("getFileNameFromUrl should return the fallback when passed a null url", () => {
	/* tslint:disable:no-null-keyword */
	let fallback = "Fallback.xyz";
...
QUnit.test("getFileNameFromUrl should return the fallback when passed an undefined url", () => {
	let fallback = "Fallback.xyz";
	strictEqual(Utils.getFileNameFromUrl(undefined, fallback), fallback,
		"The fallback should be returned");
});

QUnit.test("getQueryValue should return the query value in the general case", () => {
	let url = "www.website.com/stuff?q=v";
	strictEqual(Utils.getQueryValue(url, "q"), "v");
});

QUnit.test("getQueryValue should return the query value when there is more than one pair", () => {
...
QUnit.test("getQueryValue should return undefined if the key doesn't exist", () => {
	let url = "www.website.com/stuff?q=v";
	strictEqual(Utils.getQueryValue(url, "notexist"), undefined);
});

QUnit.test("getQueryValue should return undefined if no keys exist", () => {
...
QUnit.test("getQueryValue should return empty string if the key exists but the value doesn't", () => {
	let url = "www.website.com/stuff?q=";
	strictEqual(Utils.getQueryValue(url, "q"), "");
});

QUnit.test("getQueryValue should return undefined if any of the parameters are undefined or empty string", () => {
...
QUnit.test("isNumeric should return false when the value is a string", () => {
	let value = "string";
	ok(!Utils.isNumeric(value), "isNumeric should return false");
});

QUnit.test("isNumeric should return false when the value is a string numeral", () => {
	let value = "5";
	ok(!Utils.isNumeric(value), "isNumeric should return false");
});

QUnit.test("isNumeric should return false when the value is an empty object", () => {
	let value = {};
	ok(!Utils.isNumeric(value), "isNumeric should return false");
});

QUnit.test("isNumeric should return false when the value is a undefined", () => {
	ok(!Utils.isNumeric(undefined), "isNumeric should return false");
});

QUnit.test("isNumeric should return false when the value is a NaN", () => {
	let value = NaN;
	ok(!Utils.isNumeric(value), "isNumeric should return false");
});

QUnit.test("isNumeric should return false when the value is a null", () => {
	/* tslint:disable:no-null-keyword */
	let value = null;
	/* tslint:enable:no-null-keyword */
	ok(!Utils.isNumeric(value), "isNumeric should return false");
...
QUnit.test("isNumeric should return true when the value is a number", () => {
	let value = 5;
	ok(Utils.isNumeric(value), "isNumeric should return true");
});

QUnit.test("isNumeric should return true when the value is a negative number", () => {
	let value = -5;
	ok(Utils.isNumeric(value), "isNumeric should return true");
});

QUnit.test("isNumeric should return true when the value is a decimal number", () => {
	let value = 4.12345;
	ok(Utils.isNumeric(value), "isNumeric should return true");
});

QUnit.test("isNumeric should return true when the value is a Infinity", () => {
	let value = Infinity;
	ok(Utils.isNumeric(value), "isNumeric should return true");
});

QUnit.test("onWhiteListedDomain should return true for urls with /yyyy/mm/dd/", () => {
	ok(Utils.onWhitelistedDomain("http://www.sdfdsfsdasdsa.com/2014/09/25/garden/when-blogging-becomes-a-slog.html?_r=1"));
});

QUnit.test("onWhiteListedDomain should return true for urls with /yyyy/mm/", () => {
	ok(Utils.onWhitelistedDomain("http://www.sdfdsfsdasdsa.com/2014/09/garden/when-blogging-becomes-a-slog.html?_r=1"));
});

QUnit.test("onWhiteListedDomain should return true for urls with /yy/mm/", () => {
	ok(Utils.onWhitelistedDomain("http://www.sdfdsfsdasdsa.com/16/09/garden/when-blogging-becomes-a-slog.html?_r=1"));
});

QUnit.test("onWhiteListedDomain should return true for urls with /yyyy/m/", () => {
	ok(Utils.onWhitelistedDomain("http://www.sdfdsfsdasdsa.com/2014/1/garden/when-blogging-becomes-a-slog.html?_r=1"));
});

QUnit.test("onWhiteListedDomain should return true for urls dash-seperated dates assuming they include the year, month, and day", () => {
	ok(Utils.onWhitelistedDomain("http://www.sdfdsfsdasdsa.com/2014-09-25/garden/when-blogging-becomes-a-slog.html?_r=1"));
});

QUnit.test("onWhiteListedDomain should return false for urls dash-seperated dates assuming they do not include the year, month, and day", () => {
	ok(!Utils.onWhitelistedDomain("http://www.sdfdsfsdasdsa.com/2014-09/garden/when-blogging-becomes-a-slog.html?_r=1"));
});

QUnit.test("onWhiteListedDomain should return false for urls with just years", () => {
	ok(!Utils.onWhitelistedDomain("http://www.sdfdsfsdasdsa.com/2014/garden/when-blogging-becomes-a-slog.html?_r=1"));
});

QUnit.test("onWhiteListedDomain should return false given undefined or empty string", () => {
	ok(!Utils.onWhitelistedDomain(""));
	ok(!Utils.onWhitelistedDomain(undefined));
});

QUnit.test("getPathName should return a valid path given a valid URL", () => {
...
QUnit.test("checkIfUrlMatchesAContentType should return UNDEFINED for an undefined, null, or empty URL", () => {
...
QUnit.test("checkIfUrlMatchesAContentType for PDF should return UNDEFINED for a valid URL without .pdf at the end", () => {
...
QUnit.test("checkIfUrlMatchesAContentType for PDF should return PDF for a valid URL with .pdf at the end, case insensitive", () => {
...
QUnit.test("checkIfUrlMatchesAContentType for Product should return UNDEFINED for an invalid url", () => {
	ok(!Utils.checkIfUrlMatchesAContentType("https://www.onenote.com/clipper", tooltipsToTest));
});

QUnit.test("checkIfUrlMatchesAContentType for Product should return Product for a valid Wal-mart URL", () => {
	strictEqual(Utils.checkIfUrlMatchesAContentType("http://www.walmart.com/ip/49424374", tooltipsToTest), TooltipType.Product);
});

QUnit.test("checkIfUrlMatchesAContentType for Recipe should return UNDEFINED for a valid url that isnt in the regex match", () => {
	ok(!Utils.checkIfUrlMatchesAContentType("https://www.onenote.com/clipper", tooltipsToTest));
});

QUnit.test("checkIfUrlMatchesAContentType for Recipe should return RECIPE for a valid URL", () => {
...
QUnit.test("ensureLeadingForwardSlash should return a valid path given different browser return values.", () => {
...
QUnit.test("createUpdatedObject should return a new object that adds the attributes of the second object to the first", () => {
	let first = { a: "a", b: "b" };
	let second = { c: "c", d: "d" };
...
QUnit.test("createUpdatedObject should update the first object if it contains an attribute that the second object contains", () => {
	let first = { a: "a", b: "b" };
	let second = { b: "new" };
...
QUnit.test("createUpdatedObject should return a copy of the second object if the first is undefined", () => {
	let second = { a: "a" };
	deepEqual(Utils.createUpdatedObject(undefined, second), { a: "a" });
});

QUnit.test("createUpdatedObject should return a copy of the second object if the first is empty", () => {
	let second = { a: "a" };
	deepEqual(Utils.createUpdatedObject({}, second), { a: "a" });
});

QUnit.test("createUpdatedObject should return a copy of the first object if the second is undefined", () => {
	let first = { a: "a" };
	deepEqual(Utils.createUpdatedObject(first, undefined), { a: "a" });
});

QUnit.test("createUpdatedObject should return a copy of the first object if the second is empty", () => {
	let first = { a: "a" };
	deepEqual(Utils.createUpdatedObject(first, {}), { a: "a" });
});

QUnit.test("createUpdatedObject should return the empty object if both parameters are undefined or empty", () => {
